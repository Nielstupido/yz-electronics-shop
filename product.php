                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="assets/images/products/single/p1.jpg" data-zoom-image="assets/images/products/single/p1-big.jpg" alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">NEC VersaPro VH <br>Intel Core i5-7Y54 1.20GHz (7th gen)</h1><!-- End .product-title -->
