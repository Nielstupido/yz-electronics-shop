...
<body>
    <div class="page-wrapper">
                            ...
                            <div class="dropdown-menu">
                                <nav class="side-nav">
                                    <ul class="menu-vertical sf-arrows">
                                        ...
                                        <li class="item-lead"><a href="#">Sale</a></li>
                                        <li><a href="#">For students</a></li>
                                        <li><a href="#">For workers</a></li>
                                        <li><a href="#">Rental units/laptops</a></li>
                                        <li><a href="#">NEC</a></li>
                                        <li><a href="#">Toshiba</a></li>
                                        <li><a href="#">HP</a></li>
                                        <li><a href="#">Core i5</a></li>
                                        <li><a href="#">Celeron</a></li>
                                        <li><a href="#">With freebies</a></li>
                    ...
                    <div class="header-center">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                            ...
                                            <div class="col-md-6">
                                                <div class="menu-col">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="product.php">NEC</a></li>
                                                    </ul>
                                                </div><!-- End .menu-col -->
                                            </div><!-- End .col-md-6 -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="assets/images/menu/nec-banner2.jpg" alt="Banner">
                                ...
                                <li>
                                    <a href="blog.html" class="sf-with-ul">Reviews</a>

                                    <ul>
                                        <li><a href="blog.html">Albay</a></li>
                                        <li><a href="blog-listing.html">Camarines Sur</a></li>
                                        <li><a href="blog-listing.html">Camarines Norte</a></li>
                                        <li><a href="blog-listing.html">Catanduanes</a></li>
                                        <li><a href="blog-listing.html">Masbate</a></li>
                                        <li><a href="blog-listing.html">Sorsogon</a></li>
                                        <!--<li>
                                            <a href="#">Grid</a>
                                            <ul>
        ...
        <main class="main">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                                    ...
                                    <div class="intro-price">
                                        <sup class="intro-old-price">&#8369;15,000</sup>
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">HP Intel Corei5 5300U 8GB RAM/120GB SSD</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                    &#8369;13,600.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">NEC Intel Celeron 4GB RAM/250 GB HDD</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                    &#8369;5,800.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">NEC Intel Corei5 4GB RAM/120GB m.2 SSD
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">Intel Corei5 8GB RAM/240GB SSD</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                    &#8369;20,000.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">NEC Intel Celeron 3855U</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                    &#8369;9,500.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">NEC Intel Corei5 4GB RAM/120GB m.2 SSD</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        &#8369;9,500.00
                                        <!--<span class="new-price">&#8369;9,500.00</span>-->
                                        <!--<span class="old-price">Was $41.67</span>-->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="cta-content">
                                ...
                                <a href="#" class="btn btn-primary btn-round"><span>Get yours now for only &#8369; 8,500</span><i class="icon-long-arrow-right"></i></a>
                            </div><!-- End .cta-content -->
                        </div><!-- End .col-md-12 -->
                    </div><!-- End .row -->
                </div><!-- End .cta -->
            ...
            <div class="container for-you">
                <div class="heading heading-flex mb-3">
                   ...
                   <div class="heading-right">
                        <a href="#" class="title-link">View All Recommendation <i class="icon-long-arrow-right"></i></a>
                   </div><!-- End .heading-right -->
                </div><!-- End .heading -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.php">NEC</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">NEC</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $349.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
        ...
        <footer class="footer">
            <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(assets/images/demos/demo-4/bg-6.jpg);">
                <div class="container">
                    <div class="row justify-content-center">
                ...
                <div class="tab-pane fade" id="mobile-cats-tab" role="tabpanel" aria-labelledby="mobile-cats-link">
                    <nav class="mobile-cats-nav">
                        <ul class="mobile-cats-menu">
                            ...
                            <li><a class="mobile-cats-lead" href="#">Sales</a></li>
                            <li><a href="#">For students</a></li>
                            <li><a href="#">For workers</a></li>
                            <li><a href="#">Rental units/laptops</a></li>
                            <li><a href="#">NEC</a></li>
