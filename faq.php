    ...
    <main class="main">
        <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
            ...
            <div class="page-header text-center" style="background-image: url('assets/images/demos/demo-4/bg-7.jpg')">
        		<div class="container">
        			<h1 class="page-title text-white">F.A.Q</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-9 col-xl-7">
                            <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                                <div class="col">
                                    <h3 class="cta-title">If You Have More Questions</h3><!-- End .cta-title -->
                                    <p class="cta-desc">Please contact us through our Facebook Page</p><!-- End .cta-desc -->
                                </div><!-- End .col -->
